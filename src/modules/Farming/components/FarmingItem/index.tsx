...
export function FarmingItemInner(): JSX.Element {
    const intl = useIntl()
                    ...
                    {!farmingData.dataIsExists ? (
                        ...
                        <>
                            ...
                            <div className="farming-stats">
                                {
                                    ...
                                    && farmingData.lpTokenSymbol
                                    && farmingData.lpTokenDecimals
                                    && farmingData.lpTokenBalance
                                    && farmingData.rewardTokensAddress
                                    && farmingData.rewardTokensBalance
                                    && farmingData.rpsAmount
                                    && (
                                        <FarmingBaseInfo
                                            tvl={farmingData.tvl}
                                            apr={farmingData.apr}
                                            lpTokenSymbol={farmingData.lpTokenSymbol}
                                            lpTokenDecimal={farmingData.lpTokenDecimals}
                                            lpTokenAmount={farmingData.lpTokenBalance}
                            ...
                            <div className="farming-details">
                                {
                                    farmingData.vestingRatio
                                    && farmingData.vestingPeriodDays
                                    && (
                                        <FarmingVesting
...
export const FarmingItem = observer(FarmingItemInner)
